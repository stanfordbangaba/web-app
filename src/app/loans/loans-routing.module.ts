        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                data: {
                  title: extract('Original Schedule'),
              ...
              },
              {
                ...
                data: {
                  title: extract('Repayment Schedule'),
              ...
              },
              {
                path: 'transactions',
                data: {
                  title: extract('Loans Account Transactions'),
              ...
              },
              {
                ...
                data: {
                  title: extract('Loan Collateral Details'),
              ...
              },
              {
                ...
                data: {
                  title: extract('Loan Tranche Details'),
              ...
              },
              {
                ...
                data: {
                  title: extract('Floating Interest Rates'),
              ...
              },
              {
                ...
                data: {
                  title: extract('Standing Instructions'),
          ...
          },
          {
            ...
            component: MandateBatchItemsComponent,
            data: {title: extract('View Batch Items'), breadcrumb: 'View Batch Items'},
            resolve: {
          ...
          },
          {
            ...
            data: {
              title: extract('Edit Loans Account'),
