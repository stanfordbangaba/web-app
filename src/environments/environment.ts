...
export const environment = {
  ...
  baseApiUrl: JSON.parse(localStorage.getItem('mifosXServerURL')) || 'https://167.86.75.179:8443',  // For connecting to server running elsewhere update the base API URL
